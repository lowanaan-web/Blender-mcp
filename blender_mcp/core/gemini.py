...
- select_object(name, select), deselect_all(), set_active_object(name), select_all(), select_by_type(type)
- select_pattern(pattern), select_hierarchy(name), invert_selection(), get_selected_objects(), get_active_object()
- set_mode(mode), get_mode(), hide_unselected(), unhide_all(), focus_selected(), select_grouped(type), select_linked(type), select_random(ratio)
